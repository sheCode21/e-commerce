    ...
    public partial class initail : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "ID", "Address", "Discriminator", "Email", "FName", "Gender", "HiringDate", "LName", "Password", "PhoneNumber", "RegistrationDate", "UserType", "Username" },
                values: new object[] { 1, "Beni-Suef", "Employee", "Ahmedstoreee@gmail.com", "Ahmed", 0, new DateTime(2025, 5, 9, 19, 22, 56, 415, DateTimeKind.Local).AddTicks(9435), "Assem", "AhmedddAsss123#44", "01011890000", new DateTime(2025, 5, 9, 19, 22, 56, 415, DateTimeKind.Local).AddTicks(9443), 2, "AhmedAssemAdmin123" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "ID", "Address", "Discriminator", "Email", "FName", "Gender", "LName", "Password", "PhoneNumber", "RegistrationDate", "UserType", "Username" },
                values: new object[] { 2, "Beni-Suef", "User", "mailostoreee@gmail.com", "Mai", 1, "Assem", "MaiiiAsss123#44", "01011895030", new DateTime(2025, 5, 9, 19, 22, 56, 415, DateTimeKind.Local).AddTicks(8885), 1, "MaiAssemAdmin123" });
